    ...
    <table class="table table-hover table-striped table-condensed table-bordered">
        ...
        <?php
         ...
         /*  session_start();
          ...
          // $query= mysqli_query($con, $sql) or die("<p color=\"#f00\"> Could not query database.</p>");
            // while($rows = mysqli_fetch_assoc($query) or die("<p color=\"#f00\">Could not fetch assoc array in database.</p>"))
...
<footer class="text-center mt-5 py-5"
            <p>&copy 2021 <b>Aman Mishra </b> <br> MY BANK</p>
</footer>
